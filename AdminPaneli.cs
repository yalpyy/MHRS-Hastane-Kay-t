...
namespace HastaneKayit
{
    public partial class AdminPaneli : Form
    {
        ...
        void Hastanelerigetir()
        {
            listBoxhastaneler.Items.Clear();
            try
            {
                frm1.uyelerBaglantisi.Open();
                ...
                while (rd.Read())
                {
                    listBoxhastaneler.Items.Add(rd["hastanead"].ToString());
                }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                OleDbCommand cmd = new OleDbCommand("insert into hastaneler (hastanead) values ('" + textBox1.Text + "')", frm1.uyelerBaglantisi);
                cmd.ExecuteNonQuery();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                listBoxhastaneler.SelectedItem.ToString();

                //SİL Hastane
                frm1.uyelerBaglantisi.Open();
                OleDbCommand cmd2 = new OleDbCommand("Select * From hastaneler where hastanead='" + listBoxhastaneler.SelectedItem.ToString() + "'", frm1.uyelerBaglantisi);
                cmd2.ExecuteNonQuery();
                OleDbDataReader rd = cmd2.ExecuteReader();
                while (rd.Read())
                {
                    hastaneid = rd["hastanead"].ToString();
                }

                OleDbCommand cmd = new OleDbCommand("Delete * From hastaneler where hastanead='" + listBoxhastaneler.SelectedItem.ToString() + "'", frm1.uyelerBaglantisi);
                cmd.ExecuteNonQuery();
                frm1.uyelerBaglantisi.Close();
                Hastanelerigetir();
            ...
            {
                frm1.uyelerBaglantisi.Close();
                MessageBox.Show("Silinecek Hastaneyi Seçmediniz");
            }
        }
